...
const Convert = () => {
    ...
    useEffect(() => {
        ...
        const finalData = mapData?.map((wpPost, index) => {
            ...
            for (let img of imgs) {
                img.src = `https://admin.nobledentalcares.com/uploads/${img?.src.split('/')[img?.src.split('/').length - 1]
                    }`,
            ...
            return {
                ...
                publishedDate: wpPost.publishedAt,
            };
        });
        ...
        finalData
            ...
            .map((sin, index) => {
                // axios.post('https://admin.nobledentalcares.com/api/our-services', {
                //     data: {
                //         title: sin.title,
                ...
                //         publishedDate:sin.publishedDate
                //     }
                // });
